...
<div class="container mx-auto bg-light mt-1 w-90">
    <header class="row">
        ...
        <div class="col-sm-3">   
<img src="XPTO-removedbg-png.png" alt="Logotipo da empresa com dois triângulos sobrepostos.">
        </div>
    ...
    <section class="row">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Alterna navegação" id="menu-button">
        ...
        <form  id="form" class="needs-validation" novalidate>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control col-form-label" id="email" placeholder="Digite seu email" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-sm-10">
                    ...
                    <button id="submit" type="submit" class="btn btn-primary my-1">Enviar</button>
